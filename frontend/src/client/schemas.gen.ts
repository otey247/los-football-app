...
export const BlogPostListSchema = {
    properties: {
        data: {
            items: {
                '$ref': '#/components/schemas/BlogPostListPublic'
            },
            type: 'array',
            title: 'Data'
        },
...
export const BlogPostListPublicSchema = {
    properties: {
        title: {
            type: 'string',
            title: 'Title'
    ...
    type: 'object',
    required: ['title', 'slug', 'published', 'id', 'author_id'],
    title: 'BlogPostListPublic'
} as const;
...
export const BlogPostPublicSchema = {
    ...
    type: 'object',
    required: ['title', 'slug', 'content', 'id', 'author_id'],
...
export const PublishRecapRequestSchema = {
    properties: {
        league_id: {
            type: 'string',
            title: 'League Id',
